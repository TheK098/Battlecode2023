...
import qp1_13_tuning.communications.Comms.IslandInfo;
import qp1_13_tuning.communications.Comms.WellLocation;
import qp1_13_tuning.communications.EntityType;
import qp1_13_tuning.navigation.SpreadSettings;

import static qp1_13_tuning.navigation.Pathfinding.*;
import static qp1_13_tuning.utilities.Util.*;
...
public class Carrier extends BaseBot {
    ...
    private static boolean handleCombat(MapLocation nearestHq) throws GameActionException {
        ...
        if (enemies.length > 0) {
            ...
            int closestEnemyDist = 12960000, closestLauncherDist = 12960000;
            int distance;
            ...
            if (closestLauncher == -1 || rc.getHealth() >= 75) return false;  // carrier health is 150
...
//        Direction dir = pickDirectionForCollection(rc, targetWell);
        ...
        if (rc.canSenseLocation(targetWell)) {
            int toCollect = Math.min(39 - getCurrentResources(), rc.senseWell(targetWell).getRate());
